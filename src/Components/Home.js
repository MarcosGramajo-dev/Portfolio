            ...
            <div className={active}>
                ...
                <div className="conteinerHome" id="home">
                    ...
                    <div className="conteinerText">
                        <p>
                        ¡Hola!, Gracias por visitar mi Porfolio, te cuento algo de mi, me encuentro en la búsqueda laboral de mi primer trabajo soy estudiante de Desarrollo y calidad de Software Me considero una persona responsable y ordenado. Buscando mi primera experiencia laboral. 
                        </p>
                    </div>
                </div>
